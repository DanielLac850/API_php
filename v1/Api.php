...
function isTheseParameterAvailable($params){
    ...
    foreach($params as $param){
        if(!isset($_POST[$params]) || strlen($_POST[$param])<=0){
            $avalilable = false;
...
if(isset($_GET['apicall'])){
    switch($_GET['apicall']){
        ...
        case 'createFruta' :
            isTheseParameterAvailable(array('campo_2','campo_3','campo_4'));
        ...
        break;
        case 'updateFrutas':
            isTheseParameterAvailable(array('campo_1','campo_2','campo_3','campo_4'));
